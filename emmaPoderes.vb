...
Dim hom_Desc As String, arma As String, cvegeo As String, cuadrante As String
Dim ultFila As Long
Dim cont As Long
Dim celda As Range
...
'CALL_INC
    ...
    For cont = 2 To ultFila
        ...
        If call_Inc = "" Or call_Inc = "0" Or call_Inc = "-" Or call_Inc = " - " Or call_Inc = "M" Or call_Inc = "N" Or call_Inc = "N.P" Or call_Inc = "N.P." _
            Or call_Inc = "N/P" Or call_Inc = "N´P" Or call_Inc = "NA" Or call_Inc = "ND" Or call_Inc = "NINGUNA" Or call_Inc = "NINGUNO" Or call_Inc = "NNINGUNA" _
                Or call_Inc = "NNINGUNO" Or call_Inc = "NO" Or call_Inc = "NO  P." Or call_Inc = "NO INDICA" Or call_Inc = "NO P." Or call_Inc = "NO PROPORCIONA" _
                    Or call_Inc = "NO PROPORCIONA MAS INFORMACION" Or call_Inc = "NOINDICA" Or call_Inc = "NOPROPORCIONA" Or call_Inc = "NP" Or call_Inc = "N-P" _
                        Or call_Inc = "NP." Or call_Inc = "NPN" Or call_Inc = "NPNP" Or call_Inc = "NPNPNP" Or call_Inc = "OTRA" Or call_Inc = "OTRAS" Or call_Inc = "P" _
                            Or call_Inc = "PNP" Or call_Inc = "S" Or call_Inc = "S.D" Or call_Inc = "S.D." Or call_Inc = "S.N" Or call_Inc = "S.N." Or call_Inc = "S.P" _
                                Or call_Inc = "S.P." Or call_Inc = "S/D" Or call_Inc = "SA" Or call_Inc = "SC" Or call_Inc = "SD" Or call_Inc = "SD." Or call_Inc = "SIN" _
                                    Or call_Inc = "SIN C" Or call_Inc = "SIN CALE" Or call_Inc = "SIN CALL E" Or call_Inc = "SIN CALLE" Or call_Inc = "SIN CALLES" Or call_Inc = "SIN CLLE" _
...
'ENTRE_INC
    ...
    For cont = 2 To ultFila
        ...
        If entre_Inc = "" Or entre_Inc = "0" Or entre_Inc = "-" Or entre_Inc = " - " Or entre_Inc = "M" Or entre_Inc = "N" Or entre_Inc = "N.P" Or entre_Inc = "N.P." _
            Or entre_Inc = "N/P" Or entre_Inc = "N´P" Or entre_Inc = "NA" Or entre_Inc = "ND" Or entre_Inc = "NINGUNA" Or entre_Inc = "NINGUNO" Or entre_Inc = "NNINGUNA" _
                Or entre_Inc = "NNINGUNO" Or entre_Inc = "NO" Or entre_Inc = "NO  P." Or entre_Inc = "NO INDICA" Or entre_Inc = "NO P." Or entre_Inc = "NO PROPORCIONA" _
                    Or entre_Inc = "NO PROPORCIONA MAS INFORMACION" Or entre_Inc = "NOINDICA" Or entre_Inc = "NOPROPORCIONA" Or entre_Inc = "NP" Or entre_Inc = "N-P" _
                        Or entre_Inc = "NP." Or entre_Inc = "NPN" Or entre_Inc = "NPNP" Or entre_Inc = "NPNPNP" Or entre_Inc = "OTRA" Or entre_Inc = "OTRAS" Or entre_Inc = "P" _
                            Or entre_Inc = "PNP" Or entre_Inc = "S" Or entre_Inc = "S.D" Or entre_Inc = "S.D." Or entre_Inc = "S.N" Or entre_Inc = "S.N." Or entre_Inc = "S.P" _
                                Or entre_Inc = "S.P." Or entre_Inc = "S/D" Or entre_Inc = "SA" Or entre_Inc = "SC" Or entre_Inc = "SD" Or entre_Inc = "SD." Or entre_Inc = "SIN" _
                                    Or entre_Inc = "SIN C" Or entre_Inc = "SIN CALE" Or entre_Inc = "SIN CALL E" Or entre_Inc = "SIN CALLE" Or entre_Inc = "SIN CALLES" Or entre_Inc = "SIN CLLE" _
...
'COL_INC
    ...
    For cont = 2 To ultFila
        ...
        If col_Inc = "" Or col_Inc = "0" Or col_Inc = "-" Or col_Inc = " - " Or col_Inc = "M" Or col_Inc = "N" Or col_Inc = "N.P" Or col_Inc = "N.P." Or col_Inc = "N/P" _
            Or col_Inc = "N´P" Or col_Inc = "NA" Or col_Inc = "ND" Or col_Inc = "NINGUNA" Or col_Inc = "NINGUNO" Or col_Inc = "NNINGUNA" Or col_Inc = "NNINGUNO" _
                Or col_Inc = "NO" Or col_Inc = "NO  P." Or col_Inc = "NO INDICA" Or col_Inc = "NO P." Or col_Inc = "NO PROPORCIONA" Or col_Inc = "NO PROPORCIONA MAS INFORMACION" _
                    Or col_Inc = "NOINDICA" Or col_Inc = "NOPROPORCIONA" Or col_Inc = "NP" Or col_Inc = "N-P" Or col_Inc = "NP." Or col_Inc = "NPN" Or col_Inc = "NPNP" _
                        Or col_Inc = "NPNPNP" Or col_Inc = "OTRA" Or col_Inc = "OTRAS" Or col_Inc = "P" Or col_Inc = "PNP" Or col_Inc = "S" Or col_Inc = "S.D" Or col_Inc = "S.D." _
                            Or col_Inc = "S.N" Or col_Inc = "S.N." Or col_Inc = "S.P" Or col_Inc = "S.P." Or col_Inc = "S/D" Or col_Inc = "SA" Or col_Inc = "SC" Or col_Inc = "SD" _
...
'REF_INC
    ...
    For cont = 2 To ultFila
        ...
        If ref_Inc = "" Or ref_Inc = "0" Or ref_Inc = "-" Or ref_Inc = " - " Or ref_Inc = "M" Or ref_Inc = "N" Or ref_Inc = "N.P" Or ref_Inc = "N.P." Or ref_Inc = "N/P" _
            Or ref_Inc = "N´P" Or ref_Inc = "NA" Or ref_Inc = "ND" Or ref_Inc = "NINGUNA" Or ref_Inc = "NINGUNO" Or ref_Inc = "NNINGUNA" Or ref_Inc = "NNINGUNO" Or ref_Inc = "NO" _
                Or ref_Inc = "NO  P." Or ref_Inc = "NO INDICA" Or ref_Inc = "NO P." Or ref_Inc = "NO PROPORCIONA" Or ref_Inc = "NO PROPORCIONA MAS INFORMACION" Or ref_Inc = "NOINDICA" _
                    Or ref_Inc = "NOPROPORCIONA" Or ref_Inc = "NP" Or ref_Inc = "N-P" Or ref_Inc = "NP REFERENCIA" Or ref_Inc = "NP REFERENCIAS" Or ref_Inc = "NP." Or ref_Inc = "NPN" _
                        Or ref_Inc = "NPNP" Or ref_Inc = "NPNPNP" Or ref_Inc = "NPREFERENCIA" Or ref_Inc = "NPREFERENCIAS" Or ref_Inc = "OTRA" Or ref_Inc = "OTRAS" Or ref_Inc = "P" _
                            Or ref_Inc = "PNP" Or ref_Inc = "S" Or ref_Inc = "S.D" Or ref_Inc = "S.D." Or ref_Inc = "S.N" Or ref_Inc = "S.N." Or ref_Inc = " S/D" Or ref_Inc = "S.P" _
                                Or ref_Inc = "S.P." Or ref_Inc = "S/D" Or ref_Inc = "SA" Or ref_Inc = "SC" Or ref_Inc = "SD" Or ref_Inc = " S/D " Or ref_Inc = "SD." Or ref_Inc = "SIN" _
                                    Or ref_Inc = "SIN C" Or ref_Inc = "SIN CALE" Or ref_Inc = "SIN CALL E" Or ref_Inc = "S/D " Or ref_Inc = "SIN CALLE" Or ref_Inc = "SIN CALLES" Or ref_Inc = "SIN CLLE" _
                                        Or ref_Inc = "SIN COLONIA" Or ref_Inc = "SIN DATOS" Or ref_Inc = "SIN ESPECIFICAR" Or ref_Inc = "SIN INFORMACION" Or ref_Inc = "SIN NOMBRE" Or ref_Inc = "SIN PLACA" _
                                            Or ref_Inc = "SIN PLACAS" Or ref_Inc = "SIN REFERENCIA" Or ref_Inc = "SIN REFERENCIAS " Or ref_Inc = "SINCALLE" Or ref_Inc = "SINCALLES" Or ref_Inc = "SINDATO" _
                                                Or ref_Inc = "SINDATOS" Or ref_Inc = "SINESPECIFICAR" Or ref_Inc = "SININFORMACION" Or ref_Inc = "SINNOMBRE" Or ref_Inc = "SINPLAC" Or ref_Inc = "SINPLACA" _
...
'NOT_INC
    ...
    For cont = 2 To ultFila
        ...
        If not_Inc = "" Or not_Inc = "0" Or not_Inc = "-" Or not_Inc = " - " Or not_Inc = "M" Or not_Inc = "N" Or not_Inc = "N.P" Or not_Inc = "N.P." _
            Or not_Inc = "N/P" Or not_Inc = "N´P" Or not_Inc = "NA" Or not_Inc = "ND" Or not_Inc = "NINGUNA" Or not_Inc = "NINGUNO" Or not_Inc = "NNINGUNA" _
                Or not_Inc = "NNINGUNO" Or not_Inc = "NO" Or not_Inc = "NO  P." Or not_Inc = "NO INDICA" Or not_Inc = "NO P." Or not_Inc = "NO PROPORCIONA" _
                    Or not_Inc = "NO PROPORCIONA MAS INFORMACION" Or not_Inc = "NOINDICA" Or not_Inc = "NOPROPORCIONA" Or not_Inc = "NP" Or not_Inc = "N-P" _
                        Or not_Inc = "NP REFERENCIA" Or not_Inc = "NP REFERENCIAS" Or not_Inc = "NP." Or not_Inc = "NPN" Or not_Inc = "NPNP" Or not_Inc = "NPNPNP" _
                            Or not_Inc = "NPREFERENCIA" Or not_Inc = "NPREFERENCIAS" Or not_Inc = "OTRA" Or not_Inc = "OTRAS" Or not_Inc = "P" Or not_Inc = "PNP" _
                                Or not_Inc = "S" Or not_Inc = "S.D" Or not_Inc = "S.D." Or not_Inc = "S.N" Or not_Inc = "S.N." Or not_Inc = "S.P" Or not_Inc = "S.P." _
                                    Or not_Inc = "S/D" Or not_Inc = "SA" Or not_Inc = "SC" Or not_Inc = "SD" Or not_Inc = "SD." Or not_Inc = "SIN" Or not_Inc = "SIN C" _
                                        Or not_Inc = "SIN CALE" Or not_Inc = "SIN CALL E" Or not_Inc = "SIN CALLE" Or not_Inc = "SIN CALLES" Or not_Inc = "SIN CLLE" _
                                            Or not_Inc = "SIN COLONIA" Or not_Inc = "SIN DATOS" Or not_Inc = "SIN ESPECIFICAR" Or not_Inc = "SIN INFORMACION" Or not_Inc = "SIN NOMBRE" _
                                                Or not_Inc = "SIN PLACA" Or not_Inc = "SIN PLACAS" Or not_Inc = "SIN REFERENCIA" Or not_Inc = "SIN REFERENCIAS " Or not_Inc = "SINCALLE" _
                                                    Or not_Inc = "SINCALLES" Or not_Inc = "SINDATO" Or not_Inc = "SINDATOS" Or not_Inc = "SINESPECIFICAR" Or not_Inc = "SININFORMACION" _
...
'PLACA_V
    ...
    For cont = 2 To ultFila
        ...
        If placa_V = "" Or placa_V = " " Or placa_V = "0" Or placa_V = "-" Or placa_V = " - " Or placa_V = "00" Or placa_V = "000" Or placa_V = "0000" Or placa_V = " SN" _
...
'Esta línea transforma la columna PLACA_V "AM" a texto para quitar las celdas que están en formato científico
'Se agregaron dos líneas más para optimizar la salida en el equipo de Mar
'En este equipo se van a dejar como comentario ambas líneas
